...
// node_modules/react-pdf-highlighter/dist/node_modules/pdfjs-dist/web/pdf_viewer.js
...
var _classList;
var _disableAutoFetchTimeout;
var _percent;
var _style;
var _visible;
var _state;
var _updateMatchesCountOnProgress;
var _visitedPagesCount;
var _PDFFindController_instances;
var onFind_fn;
var reset_fn;
var query_get;
var shouldDirtyMatch_fn;
var isEntireWord_fn;
var calculateRegExpMatch_fn;
var convertToRegExpString_fn;
var calculateMatch_fn;
var extractText_fn;
var updatePage_fn;
var updateAllPages_fn;
var nextMatch_fn;
var matchesReady_fn;
var nextPageMatch_fn;
var advanceOffsetPage_fn;
var updateMatch_fn;
var onFindBarClose_fn;
var requestMatchesCount_fn;
var updateUIResultsCount_fn;
var updateUIState_fn;
var _PDFLinkService_static;
var isValidExplicitDest_fn;
var _onAppend;
var _eventAbortController;
var _AnnotationLayerBuilder_instances;
var updatePresentationModeState_fn;
var _openBlobUrls;
var _listeners;
var _dir;
var _elements;
...
var _l10n;
var _L10n_static;
var fixupLangCode_fn;
var isRTL_fn;
var _genericl10n_GenericL10n_static;
var generateBundles_fn;
var createBundle_fn;
var getPaths_fn;
var generateBundlesFallback_fn;
var createBundleFallback_fn;
var _eventAbortController2;
var _PDFHistory_instances;
var pushOrReplaceState_fn;
var tryPushCurrentPosition_fn;
var isValidPage_fn;
var isValidState_fn;
var updateInternalState_fn;
var parseCurrentHash_fn;
var updateViewarea_fn;
var popState_fn;
var pageHide_fn;
var bindEvents_fn;
var unbindEvents_fn;
...
var _drawLayer2;
var _treeDom;
var _StructTreeLayerBuilder_instances;
var setAttributes_fn;
var walk_fn;
var _enabled;
var _textChildren;
var _textNodes;
var _waitingElements;
var _TextAccessibilityManager_static;
var compareElementPositions_fn;
var _TextAccessibilityManager_instances;
var addIdToAriaOwns_fn;
var _eventAbortController3;
var _enablePermissions;
var _onAppend3;
var _renderingDone;
var _textLayer2;
var _textLayers;
var _selectionChangeAbortController;
var _TextLayerBuilder_instances;
var bindMouse_fn;
var _TextLayerBuilder_static;
var removeGlobalSelectionListener_fn;
var enableGlobalSelectionListener_fn;
var _annotationMode;
var _enableHWA;
var _hasRestrictedScaling;
var _layerProperties;
var _loadingId;
var _previousRotation;
var _renderError;
var _renderingState;
var _textLayerMode;
var _useThumbnailCanvas;
var _viewportMap;
var _layers;
var _PDFPageView_instances;
var addLayer_fn;
var setDimensions_fn;
var dispatchLayerRendered_fn;
var renderAnnotationLayer_fn;
var renderAnnotationEditorLayer_fn;
var renderDrawLayer_fn;
var renderXfaLayer_fn;
var renderTextLayer_fn;
var renderStructTreeLayer_fn;
var buildXfaTextContentItems_fn;
var finishRenderTask_fn;
var _closeCapability;
var _destroyCapability;
var _docProperties;
var _eventAbortController4;
var _eventBus;
var _externalServices;
var _pdfDocument;
var _pdfViewer;
var _ready;
var _scripting;
var _willPrintCapability;
var _PDFScriptingManager_instances;
var updateFromSandbox_fn;
var dispatchPageOpen_fn;
var dispatchPageClose_fn;
var initScripting_fn;
var destroyScripting_fn;
var _buf;
var _size;
var _PDFPageViewBuffer_instances;
var destroyFirstView_fn;
var _buffer;
var _altTextManager;
var _annotationEditorHighlightColors;
var _annotationEditorMode;
var _annotationEditorUIManager;
var _annotationMode2;
var _containerTopLeft;
var _enableHWA2;
var _enableHighlightFloatingButton;
var _enablePermissions2;
var _eventAbortController5;
var _mlManager;
var _getAllTextInProgress;
var _hiddenCopyElement;
var _interruptCopyCondition;
var _previousContainerHeight;
var _resizeObserver;
var _scrollModePageState;
var _scaleTimeoutId;
var _textLayerMode2;
var _PDFViewer_instances;
var initializePermissions_fn;
var onePageRenderedOrForceFetch_fn;
var copyCallback_fn;
var ensurePageViewVisible_fn;
var scrollIntoView_fn;
var isSameScale_fn;
var setScaleUpdatePages_fn;
var pageWidthScaleFactor_get;
var setScale_fn;
var resetCurrentPageView_fn;
var ensurePdfPageLoaded_fn;
var getScrollAhead_fn;
var updateContainerHeightCss_fn;
var resizeObserverCallback_fn;
...
_classList = /* @__PURE__ */ new WeakMap();
_disableAutoFetchTimeout = /* @__PURE__ */ new WeakMap();
_percent = /* @__PURE__ */ new WeakMap();
...
_updateMatchesCountOnProgress = /* @__PURE__ */ new WeakMap();
_visitedPagesCount = /* @__PURE__ */ new WeakMap();
_PDFFindController_instances = /* @__PURE__ */ new WeakSet();
...
var _PDFLinkService = class _PDFLinkService2 {
  constructor({
    eventBus,
  ...
  setHash(hash) {
    ...
    if (typeof dest === "string" || __privateMethod(_a = _PDFLinkService2, _PDFLinkService_static, isValidExplicitDest_fn).call(_a, dest)) {
...
_PDFLinkService_static = /* @__PURE__ */ new WeakSet();
...
_onAppend = /* @__PURE__ */ new WeakMap();
_eventAbortController = /* @__PURE__ */ new WeakMap();
_AnnotationLayerBuilder_instances = /* @__PURE__ */ new WeakSet();
...
_openBlobUrls = /* @__PURE__ */ new WeakMap();
var WaitOnType = {
  EVENT: "event",
  TIMEOUT: "timeout"
};
...
var _L10n = class _L10n2 {
  constructor({
    ...
    var _a, _b;
    __privateSet(this, _lang, __privateMethod(_a = _L10n2, _L10n_static, fixupLangCode_fn).call(_a, lang));
    __privateSet(this, _l10n, l10n);
    __privateSet(this, _dir, isRTL ?? __privateMethod(_b = _L10n2, _L10n_static, isRTL_fn).call(_b, __privateGet(this, _lang)) ? "rtl" : "ltr");
  }
  _setL10n(l10n) {
    __privateSet(this, _l10n, l10n);
  }
...
_dir = /* @__PURE__ */ new WeakMap();
_elements = /* @__PURE__ */ new WeakMap();
_lang = /* @__PURE__ */ new WeakMap();
_l10n = /* @__PURE__ */ new WeakMap();
_L10n_static = /* @__PURE__ */ new WeakSet();
...
var _genericl10n_GenericL10n = class _genericl10n_GenericL10n2 extends L10n {
  constructor(lang) {
    super({
      lang
    });
    const generateBundles = !lang ? __privateMethod(_genericl10n_GenericL10n2, _genericl10n_GenericL10n_static, generateBundlesFallback_fn).bind(_genericl10n_GenericL10n2, this.getLanguage()) : __privateMethod(_genericl10n_GenericL10n2, _genericl10n_GenericL10n_static, generateBundles_fn).bind(_genericl10n_GenericL10n2, "en-us", this.getLanguage());
    this._setL10n(new DOMLocalization([], generateBundles));
  }
};
_genericl10n_GenericL10n_static = /* @__PURE__ */ new WeakSet();
...
_eventAbortController2 = /* @__PURE__ */ new WeakMap();
_PDFHistory_instances = /* @__PURE__ */ new WeakSet();
...
_annotationLayer = /* @__PURE__ */ new WeakMap();
_drawLayer = /* @__PURE__ */ new WeakMap();
_onAppend2 = /* @__PURE__ */ new WeakMap();
_textLayer = /* @__PURE__ */ new WeakMap();
_uiManager = /* @__PURE__ */ new WeakMap();
{
...
_drawLayer2 = /* @__PURE__ */ new WeakMap();
...
_treeDom = /* @__PURE__ */ new WeakMap();
_StructTreeLayerBuilder_instances = /* @__PURE__ */ new WeakSet();
...
var _TextAccessibilityManager = class _TextAccessibilityManager2 {
  constructor() {
  ...
  enable() {
    ...
    __privateGet(this, _textChildren).sort(__privateMethod(_TextAccessibilityManager2, _TextAccessibilityManager_static, compareElementPositions_fn));
  ...
  addPointerInTextLayer(element, isRemovable) {
    ...
    const index = binarySearchFirstItem(children, (node) => {
      var _a;
      return __privateMethod(_a = _TextAccessibilityManager2, _TextAccessibilityManager_static, compareElementPositions_fn).call(_a, element, node) < 0;
    });
  ...
  moveElementInDOM(container, element, contentElement, isRemovable) {
    ...
    const index = binarySearchFirstItem(children, (node) => {
      var _a;
      return __privateMethod(_a = _TextAccessibilityManager2, _TextAccessibilityManager_static, compareElementPositions_fn).call(_a, elementToCompare, node) < 0;
    });
    if (index === 0) {
...
_textChildren = /* @__PURE__ */ new WeakMap();
_textNodes = /* @__PURE__ */ new WeakMap();
_waitingElements = /* @__PURE__ */ new WeakMap();
_TextAccessibilityManager_static = /* @__PURE__ */ new WeakSet();
...
_TextAccessibilityManager_instances = /* @__PURE__ */ new WeakSet();
...
_eventAbortController3 = /* @__PURE__ */ new WeakMap();
var _TextLayerBuilder = class _TextLayerBuilder2 {
  constructor({
    pdfPage,
    highlighter = null,
    accessibilityManager = null,
  ...
  cancel() {
    ...
    __privateMethod(_d = _TextLayerBuilder2, _TextLayerBuilder_static, removeGlobalSelectionListener_fn).call(_d, this.div);
  }
};
_enablePermissions = /* @__PURE__ */ new WeakMap();
_onAppend3 = /* @__PURE__ */ new WeakMap();
_renderingDone = /* @__PURE__ */ new WeakMap();
_textLayer2 = /* @__PURE__ */ new WeakMap();
_textLayers = /* @__PURE__ */ new WeakMap();
_selectionChangeAbortController = /* @__PURE__ */ new WeakMap();
_TextLayerBuilder_instances = /* @__PURE__ */ new WeakSet();
...
_TextLayerBuilder_static = /* @__PURE__ */ new WeakSet();
...
_annotationMode = /* @__PURE__ */ new WeakMap();
_enableHWA = /* @__PURE__ */ new WeakMap();
_hasRestrictedScaling = /* @__PURE__ */ new WeakMap();
_layerProperties = /* @__PURE__ */ new WeakMap();
_loadingId = /* @__PURE__ */ new WeakMap();
_previousRotation = /* @__PURE__ */ new WeakMap();
_renderError = /* @__PURE__ */ new WeakMap();
_renderingState = /* @__PURE__ */ new WeakMap();
_textLayerMode = /* @__PURE__ */ new WeakMap();
_useThumbnailCanvas = /* @__PURE__ */ new WeakMap();
_viewportMap = /* @__PURE__ */ new WeakMap();
_layers = /* @__PURE__ */ new WeakMap();
_PDFPageView_instances = /* @__PURE__ */ new WeakSet();
...
_closeCapability = /* @__PURE__ */ new WeakMap();
_destroyCapability = /* @__PURE__ */ new WeakMap();
_docProperties = /* @__PURE__ */ new WeakMap();
_eventAbortController4 = /* @__PURE__ */ new WeakMap();
_eventBus = /* @__PURE__ */ new WeakMap();
_externalServices = /* @__PURE__ */ new WeakMap();
_pdfDocument = /* @__PURE__ */ new WeakMap();
_pdfViewer = /* @__PURE__ */ new WeakMap();
_ready = /* @__PURE__ */ new WeakMap();
_scripting = /* @__PURE__ */ new WeakMap();
_willPrintCapability = /* @__PURE__ */ new WeakMap();
_PDFScriptingManager_instances = /* @__PURE__ */ new WeakSet();
...
_buf = /* @__PURE__ */ new WeakMap();
_size = /* @__PURE__ */ new WeakMap();
_PDFPageViewBuffer_instances = /* @__PURE__ */ new WeakSet();
...
_altTextManager = /* @__PURE__ */ new WeakMap();
_annotationEditorHighlightColors = /* @__PURE__ */ new WeakMap();
_annotationEditorMode = /* @__PURE__ */ new WeakMap();
_annotationEditorUIManager = /* @__PURE__ */ new WeakMap();
_annotationMode2 = /* @__PURE__ */ new WeakMap();
_containerTopLeft = /* @__PURE__ */ new WeakMap();
_enableHWA2 = /* @__PURE__ */ new WeakMap();
_enableHighlightFloatingButton = /* @__PURE__ */ new WeakMap();
_enablePermissions2 = /* @__PURE__ */ new WeakMap();
_eventAbortController5 = /* @__PURE__ */ new WeakMap();
_mlManager = /* @__PURE__ */ new WeakMap();
_getAllTextInProgress = /* @__PURE__ */ new WeakMap();
_hiddenCopyElement = /* @__PURE__ */ new WeakMap();
_interruptCopyCondition = /* @__PURE__ */ new WeakMap();
_previousContainerHeight = /* @__PURE__ */ new WeakMap();
_resizeObserver = /* @__PURE__ */ new WeakMap();
_scrollModePageState = /* @__PURE__ */ new WeakMap();
_scaleTimeoutId = /* @__PURE__ */ new WeakMap();
_textLayerMode2 = /* @__PURE__ */ new WeakMap();
_PDFViewer_instances = /* @__PURE__ */ new WeakSet();
...
//# sourceMappingURL=pdf_viewer-UKZ3IFYR.js.map
